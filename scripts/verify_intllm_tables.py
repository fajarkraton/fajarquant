...
CLAIMS: list[Claim] = [
    ...
    Claim("Table 2: IntLLM-Mini wikitext PPL",
          ...
          tolerance=float("inf"),
          paper_ref="Table 2 / Mini / wikitext_ppl"),
    Claim("Table 2: IntLLM-Base wikitext PPL",
          paper_value=0.0,
          source_loader=lambda: bench_canonical("intllm-base", "wikitext", "word_perplexity"),
          tolerance=float("inf"),
          paper_ref="Table 2 / Base / wikitext_ppl"),
    Claim("Table 2: IntLLM-Medium wikitext PPL",
          paper_value=0.0,
          source_loader=lambda: bench_canonical("intllm-medium", "wikitext", "word_perplexity"),
          tolerance=float("inf"),
          paper_ref="Table 2 / Medium / wikitext_ppl"),
    # HellaSwag per-config zero-shot accuracy
    Claim("Table 2: IntLLM-Mini hellaswag",
          0.0, lambda: bench_canonical("intllm-mini", "hellaswag", "acc_norm"),
          float("inf"), "Table 2 / Mini / hellaswag"),
    Claim("Table 2: IntLLM-Base hellaswag",
          0.0, lambda: bench_canonical("intllm-base", "hellaswag", "acc_norm"),
          float("inf"), "Table 2 / Base / hellaswag"),

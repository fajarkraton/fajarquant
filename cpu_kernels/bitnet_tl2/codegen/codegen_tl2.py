...
if __name__ == "__main__":
    ModelShapeDict = {
        ...
        "Llama3-8B-1.58-100B-tokens"        : [[14336, 4096],
                                               ...
                                               [1024, 4096],
                                               [4096, 4096]],
        # fajarquant V32-prep F.11.3.5 — Phase D Mini ckpt
        # (hidden=256, intermediate=768, vocab=32768) BitLinear
        # shapes. Per HGRN-bit upstream: i_proj/f_proj/g_proj/o_proj
        # share (256, 256); mlp.gate_proj is (1536, 256) (out =
        # 2 * intermediate per HGRNBitMLP swiglu chunking);
        # mlp.down_proj is (256, 768); lm_head is (32768, 256).
        "fajarquant_mini"                   : [[256, 256],
                                               [1536, 256],
                                               [256, 768],
                                               [32768, 256]]
    }

...
#define BM256_256 64
#define BBK256_256 128
template<int batch_size, int K3>
inline void three_tbl_impl_256_256(int32_t* c, int8_t* lut, uint8_t* a, uint8_t* sign) {
#ifdef __AVX2__
    ...
    const int KK = BBK256_256 / 3;
#pragma unroll
        for (int i = 0; i < BM256_256; i += 32) {
        __m256i vec_as[KK / 2];
...
#pragma unroll
        ...
        __m256i vec_gc0 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i      + BM256_256 * bs));
        __m256i vec_gc1 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM256_256 * bs));
        __m256i vec_gc2 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM256_256 * bs));
        __m256i vec_gc3 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM256_256 * bs));
        ...
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i      + BM256_256 * bs), vec_gc0);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM256_256 * bs), vec_gc1);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM256_256 * bs), vec_gc2);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM256_256 * bs), vec_gc3);
    }
    }
#endif
}
...
inline int32_t two_tbl_impl256_256(int32_t* c, int8_t* lut, uint8_t* a) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const int KK = BK2 / 2;
#pragma unroll
...
int32_t three_qgemm_lut_256_256(void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM256_256];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM256_256 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 256 / BBK256_256; ++k_outer) {
        three_tbl_impl_256_256<BATCH_SIZE, 256>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BBK256_256 / 3 * 32)])), (&(((uint8_t*)A)[(k_outer * BBK256_256 / 3 / 2 * BM256_256)])), (&(((uint8_t*)sign)[(k_outer * BBK256_256 / 3 / 8 * BM256_256)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
        for (int i = 0; i < BM256_256; i++) {
            ((int32_t*)C)[i] = (int32_t)(((int32_t*)CBits)[i + bs * BM256_256]);
        }
  }
  return 0;
}
...
template<int BATCH_SIZE>
int32_t two_qgemm_lut_256_256(void* A, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM256_256];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM256_256 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 0 / 32; ++k_outer) {
        two_tbl_impl256_256<BATCH_SIZE, 0>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BK2 / 2 * 32)])), (&(((uint8_t*)A)[(k_outer * BK2 / 2 / 2 * BM256_256)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
...
#define BM1536_256 64
#define BBK1536_256 128
template<int batch_size, int K3>
inline void three_tbl_impl_1536_256(int32_t* c, int8_t* lut, uint8_t* a, uint8_t* sign) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const __m256i vec_sign_mask  = _mm256_set1_epi16(0x8000);
    const __m256i vec_zero  = _mm256_set1_epi8(0x00);
    const __m256i vec_one  = _mm256_set1_epi8(0xff);
    const int KK = BBK1536_256 / 3;
#pragma unroll
        for (int i = 0; i < BM1536_256; i += 32) {
        __m256i vec_as[KK / 2];
        __m256i vec_signs[KK / 8];
        #pragma unroll
        for (int ai = 0; ai < KK / 2; ai++) {
...
#pragma unroll
        ...
        __m256i vec_gc0 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i      + BM1536_256 * bs));
        __m256i vec_gc1 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM1536_256 * bs));
        __m256i vec_gc2 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM1536_256 * bs));
        __m256i vec_gc3 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM1536_256 * bs));
        vec_gc0 = _mm256_add_epi32(vec_gc0, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c0)));
        vec_gc1 = _mm256_add_epi32(vec_gc1, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c0, 1)));
        vec_gc2 = _mm256_add_epi32(vec_gc2, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c1)));
        vec_gc3 = _mm256_add_epi32(vec_gc3, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c1, 1)));
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i      + BM1536_256 * bs), vec_gc0);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM1536_256 * bs), vec_gc1);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM1536_256 * bs), vec_gc2);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM1536_256 * bs), vec_gc3);
    }
    }
#endif
}
...
template<int batch_size, int K2>
inline int32_t two_tbl_impl1536_256(int32_t* c, int8_t* lut, uint8_t* a) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const int KK = BK2 / 2;
#pragma unroll
...
template<int BATCH_SIZE>
int32_t three_qgemm_lut_1536_256(void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM1536_256];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM1536_256 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 256 / BBK1536_256; ++k_outer) {
        three_tbl_impl_1536_256<BATCH_SIZE, 256>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BBK1536_256 / 3 * 32)])), (&(((uint8_t*)A)[(k_outer * BBK1536_256 / 3 / 2 * BM1536_256)])), (&(((uint8_t*)sign)[(k_outer * BBK1536_256 / 3 / 8 * BM1536_256)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
        for (int i = 0; i < BM1536_256; i++) {
            ((int32_t*)C)[i] = (int32_t)(((int32_t*)CBits)[i + bs * BM1536_256]);
        }
  }
  return 0;
}
...
template<int BATCH_SIZE>
int32_t two_qgemm_lut_1536_256(void* A, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM1536_256];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM1536_256 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 0 / 32; ++k_outer) {
        two_tbl_impl1536_256<BATCH_SIZE, 0>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BK2 / 2 * 32)])), (&(((uint8_t*)A)[(k_outer * BK2 / 2 / 2 * BM1536_256)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
...
#define BM256_768 64
#define BBK256_768 128
template<int batch_size, int K3>
inline void three_tbl_impl_256_768(int32_t* c, int8_t* lut, uint8_t* a, uint8_t* sign) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const __m256i vec_sign_mask  = _mm256_set1_epi16(0x8000);
    const __m256i vec_zero  = _mm256_set1_epi8(0x00);
    const __m256i vec_one  = _mm256_set1_epi8(0xff);
    const int KK = BBK256_768 / 3;
#pragma unroll
        for (int i = 0; i < BM256_768; i += 32) {
        __m256i vec_as[KK / 2];
        __m256i vec_signs[KK / 8];
        #pragma unroll
        for (int ai = 0; ai < KK / 2; ai++) {
...
#pragma unroll
        ...
        __m256i vec_gc0 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i      + BM256_768 * bs));
        __m256i vec_gc1 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM256_768 * bs));
        __m256i vec_gc2 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM256_768 * bs));
        __m256i vec_gc3 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM256_768 * bs));
        vec_gc0 = _mm256_add_epi32(vec_gc0, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c0)));
        vec_gc1 = _mm256_add_epi32(vec_gc1, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c0, 1)));
        vec_gc2 = _mm256_add_epi32(vec_gc2, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c1)));
        vec_gc3 = _mm256_add_epi32(vec_gc3, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c1, 1)));
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i      + BM256_768 * bs), vec_gc0);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM256_768 * bs), vec_gc1);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM256_768 * bs), vec_gc2);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM256_768 * bs), vec_gc3);
    }
    }
#endif
}
...
template<int batch_size, int K2>
inline int32_t two_tbl_impl256_768(int32_t* c, int8_t* lut, uint8_t* a) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const int KK = BK2 / 2;
#pragma unroll
...
template<int BATCH_SIZE>
int32_t three_qgemm_lut_256_768(void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM256_768];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM256_768 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 768 / BBK256_768; ++k_outer) {
        three_tbl_impl_256_768<BATCH_SIZE, 768>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BBK256_768 / 3 * 32)])), (&(((uint8_t*)A)[(k_outer * BBK256_768 / 3 / 2 * BM256_768)])), (&(((uint8_t*)sign)[(k_outer * BBK256_768 / 3 / 8 * BM256_768)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
        for (int i = 0; i < BM256_768; i++) {
            ((int32_t*)C)[i] = (int32_t)(((int32_t*)CBits)[i + bs * BM256_768]);
        }
  }
  return 0;
}
...
template<int BATCH_SIZE>
int32_t two_qgemm_lut_256_768(void* A, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM256_768];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM256_768 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 0 / 32; ++k_outer) {
        two_tbl_impl256_768<BATCH_SIZE, 0>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BK2 / 2 * 32)])), (&(((uint8_t*)A)[(k_outer * BK2 / 2 / 2 * BM256_768)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
...
#define BM32768_256 64
#define BBK32768_256 128
template<int batch_size, int K3>
inline void three_tbl_impl_32768_256(int32_t* c, int8_t* lut, uint8_t* a, uint8_t* sign) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const __m256i vec_sign_mask  = _mm256_set1_epi16(0x8000);
    const __m256i vec_zero  = _mm256_set1_epi8(0x00);
    const __m256i vec_one  = _mm256_set1_epi8(0xff);
    const int KK = BBK32768_256 / 3;
#pragma unroll
        for (int i = 0; i < BM32768_256; i += 32) {
        __m256i vec_as[KK / 2];
        __m256i vec_signs[KK / 8];
        #pragma unroll
        for (int ai = 0; ai < KK / 2; ai++) {
...
#pragma unroll
        ...
        __m256i vec_gc0 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i      + BM32768_256 * bs));
        __m256i vec_gc1 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM32768_256 * bs));
        __m256i vec_gc2 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM32768_256 * bs));
        __m256i vec_gc3 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM32768_256 * bs));
        vec_gc0 = _mm256_add_epi32(vec_gc0, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c0)));
        vec_gc1 = _mm256_add_epi32(vec_gc1, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c0, 1)));
        vec_gc2 = _mm256_add_epi32(vec_gc2, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c1)));
        vec_gc3 = _mm256_add_epi32(vec_gc3, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c1, 1)));
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i      + BM32768_256 * bs), vec_gc0);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM32768_256 * bs), vec_gc1);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM32768_256 * bs), vec_gc2);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM32768_256 * bs), vec_gc3);
    }
    }
#endif
}
...
template<int batch_size, int K2>
inline int32_t two_tbl_impl32768_256(int32_t* c, int8_t* lut, uint8_t* a) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const int KK = BK2 / 2;
#pragma unroll
...
template<int BATCH_SIZE>
int32_t three_qgemm_lut_32768_256(void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM32768_256];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM32768_256 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 256 / BBK32768_256; ++k_outer) {
        three_tbl_impl_32768_256<BATCH_SIZE, 256>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BBK32768_256 / 3 * 32)])), (&(((uint8_t*)A)[(k_outer * BBK32768_256 / 3 / 2 * BM32768_256)])), (&(((uint8_t*)sign)[(k_outer * BBK32768_256 / 3 / 8 * BM32768_256)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
        for (int i = 0; i < BM32768_256; i++) {
            ((int32_t*)C)[i] = (int32_t)(((int32_t*)CBits)[i + bs * BM32768_256]);
        }
  }
  return 0;
}
...
template<int BATCH_SIZE>
int32_t two_qgemm_lut_32768_256(void* A, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM32768_256];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM32768_256 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 0 / 32; ++k_outer) {
        two_tbl_impl32768_256<BATCH_SIZE, 0>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BK2 / 2 * 32)])), (&(((uint8_t*)A)[(k_outer * BK2 / 2 / 2 * BM32768_256)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
...
void ggml_preprocessor(int bs, int m, int three_k, int two_k, void* B, void* LUT_Scales, void* Three_QLUT, void* Two_QLUT) {
    ...
    if (m == 256 && two_k == 0 && three_k == 256) {
        for (int32_t b = 0; b < bs; b++) {
            per_tensor_quant(two_k + three_k, (&(((float*)LUT_Scales)[b])), (&(((float*)B)[b * (two_k + three_k)])));
            three_lut_ctor<256>((&(((int8_t*)Three_QLUT)[b * three_k / 3 * 32])), (&(((float*)B)[b * (three_k + two_k)])), (&(((float*)LUT_Scales)[b])));
            two_lut_ctor<0>((&(((int8_t*)Two_QLUT)[b * two_k / 2 * 32])), (&(((float*)B)[b * (three_k + two_k) + 256])), (&(((float*)LUT_Scales)[b])));
        }
    }
    else if (m == 1536 && two_k == 0 && three_k == 256) {
        for (int32_t b = 0; b < bs; b++) {
            per_tensor_quant(two_k + three_k, (&(((float*)LUT_Scales)[b])), (&(((float*)B)[b * (two_k + three_k)])));
            three_lut_ctor<256>((&(((int8_t*)Three_QLUT)[b * three_k / 3 * 32])), (&(((float*)B)[b * (three_k + two_k)])), (&(((float*)LUT_Scales)[b])));
            two_lut_ctor<0>((&(((int8_t*)Two_QLUT)[b * two_k / 2 * 32])), (&(((float*)B)[b * (three_k + two_k) + 256])), (&(((float*)LUT_Scales)[b])));
    ...
    else if (m == 256 && two_k == 0 && three_k == 768) {
        for (int32_t b = 0; b < bs; b++) {
            per_tensor_quant(two_k + three_k, (&(((float*)LUT_Scales)[b])), (&(((float*)B)[b * (two_k + three_k)])));
    ...
    else if (m == 32768 && two_k == 0 && three_k == 256) {
        for (int32_t b = 0; b < bs; b++) {
            per_tensor_quant(two_k + three_k, (&(((float*)LUT_Scales)[b])), (&(((float*)B)[b * (two_k + three_k)])));
            three_lut_ctor<256>((&(((int8_t*)Three_QLUT)[b * three_k / 3 * 32])), (&(((float*)B)[b * (three_k + two_k)])), (&(((float*)LUT_Scales)[b])));
            two_lut_ctor<0>((&(((int8_t*)Two_QLUT)[b * two_k / 2 * 32])), (&(((float*)B)[b * (three_k + two_k) + 256])), (&(((float*)LUT_Scales)[b])));
...
void ggml_qgemm_lut(int bs, int m, int k, int BK, void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    if (m == 256 && k == 256) {
        if (BK == 0) {
            if (bs == 1) {
                two_qgemm_lut_256_256<1>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 8) {
                two_qgemm_lut_256_256<8>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 32) {
                two_qgemm_lut_256_256<32>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 128) {
                two_qgemm_lut_256_256<128>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 256) {
                two_qgemm_lut_256_256<256>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 512) {
                two_qgemm_lut_256_256<512>(A, LUT, Scales, LUT_Scales, C);
            }
        }
        else if (BK == 256) {
            if (bs == 1) {
                three_qgemm_lut_256_256<1>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 8) {
                three_qgemm_lut_256_256<8>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 32) {
                three_qgemm_lut_256_256<32>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 128) {
                three_qgemm_lut_256_256<128>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 256) {
                three_qgemm_lut_256_256<256>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 512) {
                three_qgemm_lut_256_256<512>(A, sign, LUT, Scales, LUT_Scales, C);
            }
        }
    }
    else if (m == 1536 && k == 256) {
        if (BK == 0) {
            if (bs == 1) {
                two_qgemm_lut_1536_256<1>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 8) {
                two_qgemm_lut_1536_256<8>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 32) {
                two_qgemm_lut_1536_256<32>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 128) {
                two_qgemm_lut_1536_256<128>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 256) {
                two_qgemm_lut_1536_256<256>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 512) {
                two_qgemm_lut_1536_256<512>(A, LUT, Scales, LUT_Scales, C);
            }
        }
        else if (BK == 256) {
            if (bs == 1) {
                three_qgemm_lut_1536_256<1>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 8) {
                three_qgemm_lut_1536_256<8>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 32) {
                three_qgemm_lut_1536_256<32>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 128) {
                three_qgemm_lut_1536_256<128>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 256) {
                three_qgemm_lut_1536_256<256>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 512) {
                three_qgemm_lut_1536_256<512>(A, sign, LUT, Scales, LUT_Scales, C);
            }
        }
    }
    else if (m == 256 && k == 768) {
        if (BK == 0) {
            if (bs == 1) {
                two_qgemm_lut_256_768<1>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 8) {
                two_qgemm_lut_256_768<8>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 32) {
                two_qgemm_lut_256_768<32>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 128) {
                two_qgemm_lut_256_768<128>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 256) {
                two_qgemm_lut_256_768<256>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 512) {
                two_qgemm_lut_256_768<512>(A, LUT, Scales, LUT_Scales, C);
            }
        }
        else if (BK == 768) {
            if (bs == 1) {
                three_qgemm_lut_256_768<1>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 8) {
                three_qgemm_lut_256_768<8>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 32) {
                three_qgemm_lut_256_768<32>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 128) {
                three_qgemm_lut_256_768<128>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 256) {
                three_qgemm_lut_256_768<256>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 512) {
                three_qgemm_lut_256_768<512>(A, sign, LUT, Scales, LUT_Scales, C);
            }
        }
    }
    else if (m == 32768 && k == 256) {
        if (BK == 0) {
            if (bs == 1) {
                two_qgemm_lut_32768_256<1>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 8) {
                two_qgemm_lut_32768_256<8>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 32) {
                two_qgemm_lut_32768_256<32>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 128) {
                two_qgemm_lut_32768_256<128>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 256) {
                two_qgemm_lut_32768_256<256>(A, LUT, Scales, LUT_Scales, C);
            } else if (bs == 512) {
                two_qgemm_lut_32768_256<512>(A, LUT, Scales, LUT_Scales, C);
            }
        }
        else if (BK == 256) {
            if (bs == 1) {
                three_qgemm_lut_32768_256<1>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 8) {
                three_qgemm_lut_32768_256<8>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 32) {
                three_qgemm_lut_32768_256<32>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 128) {
                three_qgemm_lut_32768_256<128>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 256) {
                three_qgemm_lut_32768_256<256>(A, sign, LUT, Scales, LUT_Scales, C);
            }else if (bs == 512) {
                three_qgemm_lut_32768_256<512>(A, sign, LUT, Scales, LUT_Scales, C);
            }
        }
    }
}

...
def main() -> int:
    ...
    p.add_argument(
        ...
        type=int,
        default=None,
        help="Override MediumTrainConfig.ckpt_every (default 20000). Useful for "
        "ablation runs (24K steps) where the Phase-D-tuned 20K cadence yields "
        "only 1 mid-ckpt; pass e.g. 4000 for 6 mid-ckpts (~24min loss-cap).",
    )
    p.add_argument(
        "--out",
        type=Path,

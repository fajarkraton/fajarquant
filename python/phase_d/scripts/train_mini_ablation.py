...
def main() -> int:
    ...
    p.add_argument(
        ...
        type=int,
        default=None,
        help="Override MiniTrainConfig.ckpt_every. Useful for ablation runs "
        "where the Phase-D-tuned cadence yields too few mid-ckpts.",
    )
    p.add_argument(
        "--out",
        type=Path,
    ...
    # F.10.4 — Sparse-BitNet 2:4 structured sparsity flag
    ...
    p.add_argument(
        ...
        help=(
            ...
            "0 = recompute every forward (most accurate, highest Triton kernel launch "
            "overhead). 100 (default) = balanced: mask freshness vs compute cost. "
    ...
    # identity after replacement). Per docs/FJQ_PHASE_F_F10_PRODUCTION_PLAN_V0.md
    # F.10.4 wiring spec.
    if args.sparse_2_4:
